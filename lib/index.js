...
var useModel = function (Class) {
    ...
    (0, vue_1.onBeforeUnmount)(function () {
        EventBus_1.eventBus.off(eventName, setData);
        cancelWatch();
    });
    return data;
};
