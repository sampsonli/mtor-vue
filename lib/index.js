 ...
 * @param Class 模块类
 */
const useModel = (Class) => {
    const ns = Class.ns;
    const target = Object.create(allProto[ns]);
 ...
 */
export const useInitModel = (Clazz, initFn = () => null, clean = true) => {
